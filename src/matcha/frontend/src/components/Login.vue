	...
	<v-container class="mt-4">
		...
		<div class="login mt-5">
			...
			<v-form v-model="valid" class="my-4">
				<v-text-field color="primary" class="my-5" v-model="username" :rules="usernameRules" label="Username" required ></v-text-field>
				<v-text-field color="primary" class="my-5" v-model="password" :rules="passRules" label="Password" required :append-icon="showPass ? 'visibility' : 'visibility_off'" :type="showPass ? 'text' : 'password'" @click:append="showPass = !showPass"></v-text-field>
